<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Banner.aspx.cs" Inherits="yonetim_Banner" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Banner </h2>
</div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Banner Listele </h5></div>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:40%;"><%#Eval("BannerAdi") %></td>
                        
                         <td style="width:5%;"><a href="Banner.aspx?Duzenle=<%#Eval("BannerId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Banner.aspx?Sil=<%#Eval("BannerId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
