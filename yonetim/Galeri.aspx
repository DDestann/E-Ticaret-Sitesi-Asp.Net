<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Galeri.aspx.cs" Inherits="yonetim_Galeri" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Galeri </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
    ...
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtGaleriAd" class="form-control"  placeholder="Galeri Adı"  runat="server"></asp:TextBox>
    </div>
  </div>
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Galeri Listele </h5></div>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:40%;"><%#Eval("GaleriAdi") %></td>
                        
                         <td style="width:5%;"><a href="Galeri.aspx?Duzenle=<%#Eval("GaleriId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Galeri.aspx?Sil=<%#Eval("GaleriId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
