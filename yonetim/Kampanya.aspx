<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Kampanya.aspx.cs" Inherits="yonetim_Kampanya" %>
...
<div class="panel panel-primary">
      <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik">Kampanyada Olmayan Ürünler<%-- <asp:Label ID="lblBaslik" runat="server" Text=""></asp:Label>--%> </h5></div>
...
<div class="col-md-12">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
      ...
      <tr class="Tablo-bg Sekil">
        ...
        <th style="width:10%;" >indirim</th>
        <th style="width:10%;">Onay</th>
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         ...
                         <td style="width:50%;"><%#Eval("AltKategoriAdi") %></td>
                        <td style="width:10%;"><%#Eval("AltKategoriFiyat") %></td>
                         <td style="width:10%;"><%#Eval("AltKategoriYFiyat") %></td>
                         <td style="width:10%;"><a href="Kampanya.aspx?Onay=<%#Eval("AltKategoriId") %>">
...
<div class=" col-sm-5 col-md-5">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Kampanyada Olan Ürünler&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             ...
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                        ...
                        <td style="width:10%;"><%#Eval("AltKategoriFiyat") %></td>
                        <td style="width:10%;"><%#Eval("AltKategoriYFiyat") %></td>
                         <td style="width:10%;"><a href="Kampanya.aspx?Kaldir=<%#Eval("AltKategoriId") %>">
