<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Sayfalar.aspx.cs" Inherits="yonetim_Sayfalar" %>
...
<div class=" col-sm-9  col-md-10">
  <h2 class=" page-header Baslik slidbar_top"> Sayfa icerik </h2>
</div>
...
<div class="col-md-8"> <input type="text" class="form-control" placeholder="Search..."> </div>
      ...
      <asp:Label  ID="Label1" runat="server" class="col-sm-3 lable_Color">Başlık</asp:Label>
    <div class="col-sm-9 ">
        <asp:TextBox ID="txtBaslik" class="form-control"  placeholder="Baslik" runat="server"></asp:TextBox>
    </div>
  </div>
                  <div class="form-group">
...
<div class=" col-sm-9 col-md-6">
   ...
   <div class="panel panel-primary">
     <div class="panel-heading panel-heading-Height"><h5 class=" AltBaslik"> Anaicerik Listele </h5></div>
        ...
        <th  style="width:5%;">Sil</th>
         ...
         <itemtemplate>
             <table class="table table-hover ">
                 <tbody>
                     <tr>
                         <td style="width:30%;"><%#Eval("SayfaAdi") %></td>
                         <td style="width:60%;"><%#metin_kisalt_yan(Eval("Icerik").ToString().Trim()) %></td>
                                   
                         <td style="width:5%;"><a href="Sayfalar.aspx?Duzenle=<%#Eval("SayfaId") %>">
                             <img src="images/user_edit.png"></a></td>
                         <td style="width:5%;"><a href="Sayfalar.aspx?Sil=<%#Eval("SayfaId") %>" onclick='return confirm("Silmek istediğinizden emin misiniz?");'>
